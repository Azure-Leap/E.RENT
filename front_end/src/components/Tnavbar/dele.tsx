...
const Dele = () => {
  const { user, setUser, supplier, setSupplier }: any = useContext(AuthContext);
  const { cartItems, addItemToCart, removeItem, updateCard, getCartList, setCartItems }: any = useContext(CartContext);
